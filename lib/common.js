...
exports.CONFIG_PATH = path_1.resolve('./p8.json');
var MINIMAL_CONFIG = {
    name: '',
    main: ''
};
            ...
            switch (_a.label) {
                case 0:
                    if (!fs_1["default"].existsSync(exports.CONFIG_PATH))
                        return [2 /*return*/, MINIMAL_CONFIG];
                    return [4 /*yield*/, readFile(exports.CONFIG_PATH)];
                case 1:
                    json = _a.sent();
                    cfg = JSON.parse("" + json);
                    return [2 /*return*/, __assign(__assign({}, MINIMAL_CONFIG), cfg)];
            }
        });
    });
}
